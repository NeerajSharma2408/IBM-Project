...
let healthArticleList = [
    {
        imgUrl: "https://blog-images-1.pharmeasy.in/blog/production/wp-content/uploads/2023/07/18083511/BLOG-01-6.jpg?dim=1440x0",
        title: "Can Brisk Walking Be Beneficial For People With Diabetes?",
    },
    {
        imgUrl: "https://blog-images-1.pharmeasy.in/blog/production/wp-content/uploads/2023/07/18083511/BLOG-01-6.jpg?dim=1440x0",
        title: "The Significance Of Low Glycemic Index Food In A Diabetic Diet",
    },
    {
        imgUrl: "https://blog-images-1.pharmeasy.in/blog/production/wp-content/uploads/2023/07/11093134/shutterstock_1301337394-1-768x511-1.jpg?dim=1280x0",
        title: "The Basic Things You Should Know About Anaemia!",
    },
    {
        imgUrl: "https://blog-images-1.pharmeasy.in/blog/production/wp-content/uploads/2023/07/10093300/Pharmeasy-blog-7.jpg?dim=1280x0",
        title: "सीपीके परीक्षण (CPK Test): क्या है, खर्च, नॉर्मल रेंज, कैसे होता है, क्यों और कब",
    },
    {
        imgUrl: "https://blog-images-1.pharmeasy.in/blog/production/wp-content/uploads/2023/07/05130936/31-1.jpg?dim=1280x0",
        title: "हीमोग्लोबिन परीक्षण (Hemoglobin Test): क्या है, खर्च, नॉर्मल रेंज, कैसे होता है, क्यों और कब",
    },
    {
        imgUrl: "https://blog-images-1.pharmeasy.in/blog/production/wp-content/uploads/2023/07/05125742/21.jpg?dim=1280x0",
        title: "कार्सिनोएम्ब्रियोनिक एंटीजन परीक्षण (सीईए) (Carcinoembryonic Antigen Test (CEA)): क्या है, खर्च, नॉर्मल रेंज, कैसे होता है, क्यों और कब",
    },
];
...
let wellnessEssentialsContainer = document.querySelector(
    ".wellness-essentials > .product-cards2"
);
createProductList(wellnessEssentialsList, wellnessEssentialsContainer);

let featuredBrandContainer = document.querySelector(
    ".featured-brands > .brand-promo"
);
createFeaturedBrandList(featuredBrandList, featuredBrandContainer);

let featuredBrandOfferContainer = document.querySelector(
    ".featured-brands > .brand-offer"
);
createOfferList(featuredBrandOfferList, featuredBrandOfferContainer);

let dealsOfTheDayContainer = document.querySelector(
    ".deals-of-the-day > .product-cards"
);
...
let spotlightPromoContainer = document.querySelector(
...
let customerReviewContainer = document.querySelector(
...
function createFeaturedBrandList(list, container) {
    list.forEach(function (el) {
        let div = document.createElement("div");
        let img = document.createElement("img");
        let name = document.createElement("h4");
